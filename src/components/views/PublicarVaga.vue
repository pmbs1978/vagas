<template>
  <div class="container py-4">
    ...
    <div class="row mt-3">
      <div class="col">
        <label for="" class="form-label"> Descrição da Vaga </label>
        <textarea
          type="text"
          class="form-control"
          v-model="descricao"
    ...
    <div class="row mt-3">
      ...
      <div class="col">
        ...
        <div class="form-text">Informe o tipo de contrtação.</div>
      </div>
    </div>
    ...
    salvarVaga() {
      ...
      if (this.validaFormulario()) {
        ...
        this.emitter.emit("alerta", {
          ...
          descricao:
            "Prabéns, a vaga foi adicionada e pode ser consultada por milhares de profissionais!",
        });
